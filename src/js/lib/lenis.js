...
// Vendorizado do pacote npm "lenis" (dist/lenis.js, build UMD).
// Concatenado/minificado via gulp (libsConfig) → dist/js/libs.min.js.
// Não editar à mão — para atualizar, reinstale o pacote e recopie
// node_modules/lenis/dist/lenis.js por cima deste arquivo.
// ============================================================
(function() {
